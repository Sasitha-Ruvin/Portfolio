...
import { CanvasRevealEffect } from "@/components/ui/CanvavRevealEffect";
  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="I'll Collaborate to map out your application's goals, target audience and key functionalities. I'll discuss things like software structure, naviagtion and content requirements"
        ...
        description="Once We agree on the plab. I will dive into coding. From initial Sketches to polished code, I keep you updated with every step of the way">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        description="Based on the approved design, I'll translate everything into functional code, building your application from ground up"
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div>
        <button className="p-[3px] relative">
             <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg text-2xl" />
